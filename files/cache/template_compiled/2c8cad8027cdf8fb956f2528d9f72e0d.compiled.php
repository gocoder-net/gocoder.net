				...
				<div class="wrap_account xe_width clearBoth">
					<div class="account <?php echo $__Context->layout_info->color_login ?> <?php echo $__Context->layout_info->bg_account ?>">
						<ul class="clearBoth wrap_login">
                                                <li class="first_top"><a href="http://gocoder.net/">HOME</a></li>
                                                <li class="first_login"><a href="http://gocoder.tistory.com" target="_blank">BLOG</a></li>
                                                <li class="first_login"><a href="http://resume.gocoder.net" target="_blank">RESUME</a></li>
...
<a  class="ds_dw">Design by <span class="skin_by"> DoorWeb,GoCoder</span></a>
			</div>
