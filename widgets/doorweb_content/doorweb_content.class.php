<?php
    ...
    class doorweb_content extends WidgetHandler {
        ...
        function proc($args) {
            ...
            // Get module information after listing module_srls if the module is not RSS
                ...
                if(!$args->module_srls){
                    ...
                    $output = executeQueryArray('widgets.doorweb_content.getMids', $obj);
                    if($output->data) {
        ...
        /**
         * @brief Get a list of comments and return doorweb_contentItem
         **/
        function _getCommentItems($args) {
            ...
            foreach($output as $key => $oComment) {
                ...
                $content_item = new doorweb_contentItem($browser_title);
        ...
        function _getDocumentItems($args){
            ...
            // Get categories
            $obj->module_srl = $args->module_srl;
            $output = executeQueryArray('widgets.doorweb_content.getCategories',$obj);
            ...
            $output = executeQueryArray('widgets.doorweb_content.getNewestDocuments', $obj);
            ...
            if(count($output->data)) {
                ...
                for($i=0,$c=count($document_srls);$i<$c;$i++) {
                    ...
                    $content_item = new doorweb_contentItem( $args->module_srls_info[$module_srl]->browser_title );
        ...
        function _getRssItems($args){
            ...
            if($xml_doc->rss) {
                ...
                foreach ($items as $key => $value) {
                    ...
                    $content_item = new doorweb_contentItem($rss->title);
    ...
    class doorweb_contentItem extends BaseObject {
        ...
        function doorweb_contentItem($browser_title=''){
